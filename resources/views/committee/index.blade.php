...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-center align-items-center mb-4 px-2 pb-3 border-bottom">
        <div class="text-center">
            <h2 class="fw-semibold text-dark mb-1">Committees & Members</h2>
            <p class="text-muted mb-0">Each committee with its members</p>
        </div>
    </div>
...
<script>
    ...
    function loadData() {
        axios.get(`${BASE_URL}/api/standing-committee`)
            .then(response => {
