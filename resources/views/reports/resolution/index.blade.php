...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-center align-items-center mb-4 px-2 pb-3">
        <div class="text-center">
            <h2 class="fw-semibold text-dark mb-1">Resolution</h2>
            <p class="text-muted mb-0">View the list of Resolution</p>
        </div>
    </div>
...
<script>
    ...
    function loadDocuments(page = 1) {
        ...
        formData.push({ name: 'type', value: 2 }); // Add fixed type filter if needed
