...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-center align-items-center mb-4 px-2 pb-3">
        <div class="text-center">
            <h2 class="fw-semibold text-dark mb-1">Committee Reports</h2>
            <p class="text-muted mb-0">View the list of Committee Reports</p>
        </div>
    </div>
...
<script>
    ...
    function loadData() {
        ...
        formData.push({ name: 'type', value: 1 }); // Force type = 1
